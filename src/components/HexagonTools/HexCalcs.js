...
// import converted game closure hexagon tools and decorate onto static Utilities
HT.Util = {};

HT.Util.findHexWithSideLengthZAndRatio = function () {
...
HT.Util.findHexWithWidthAndHeight = function () {
...
HT.Util.getHexGridZR = function () {
	findHexWithSideLengthZAndRatio();
	drawHexGrid();
}

HT.Util.getHexGridWH = function () {
	findHexWithWidthAndHeight();
	drawHexGrid();
}

HT.Util.changeOrientation = function () {
...
HT.Util.debugHexZR = function () {
	findHexWithSideLengthZAndRatio();
	addHexToCanvasAndDraw(20, 20);
}

HT.Util.debugHexWH = function () {
	findHexWithWidthAndHeight();
	addHexToCanvasAndDraw(20, 20);
}

HT.Util.addHexToCanvasAndDraw = function (x, y) {
